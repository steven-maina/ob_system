...
} from "./chunk-RBIQLWXI.js";
import {
  dataTables_default,
  init_dataTables
} from "./chunk-BHYV3SDJ.js";
import {
  require_jquery
...
// node_modules/.pnpm/datatables.net-rowgroup-bs5@1.4.1/node_modules/datatables.net-rowgroup-bs5/js/rowGroup.bootstrap5.mjs
var import_jquery2 = __toESM(require_jquery(), 1);

// node_modules/.pnpm/datatables.net-rowgroup@1.5.0/node_modules/datatables.net-rowgroup/js/dataTables.rowGroup.mjs
var import_jquery = __toESM(require_jquery(), 1);
init_dataTables();
var $ = import_jquery.default;
var RowGroup = function(dt, opts) {
  if (!dataTables_default.versionCheck || !dataTables_default.versionCheck("1.11")) {
    throw "RowGroup requires DataTables 1.11 or newer";
  }
  this.c = $.extend(true, {}, dataTables_default.defaults.rowGroup, RowGroup.defaults, opts);
  this.s = {
...
$.extend(RowGroup.prototype, {
  ...
  _group: function(level, rows) {
    ...
    var fn = dataTables_default.util.get(fns[level]);
    var dt = this.s.dt;
    var group, last;
    var i, ien;
    var data = [];
...
$.fn.DataTable.RowGroup = RowGroup;
dataTables_default.Api.register("rowGroup()", function() {
  return this;
});
dataTables_default.Api.register("rowGroup().disable()", function() {
...
dataTables_default.Api.register("rowGroup().enable()", function(opts) {
  return this.iterator("table", function(ctx) {
    if (ctx.rowGroup) {
...
dataTables_default.Api.register("rowGroup().enabled()", function() {
  var ctx = this.context;
  return ctx.length && ctx[0].rowGroup ? ctx[0].rowGroup.enabled() : false;
});
dataTables_default.Api.register("rowGroup().dataSrc()", function(val) {
  if (val === void 0) {
...
$(document).on("preInit.dt.dtrg", function(e, settings, json) {
  ...
  var defaults = dataTables_default.defaults.rowGroup;
  if (init || defaults) {
