...
hoistedDependencies:
  ...
  /@foliojs-fork/fontkit/1.9.1:
    '@foliojs-fork/fontkit': private
  /@foliojs-fork/linebreak/1.1.1:
    '@foliojs-fork/linebreak': private
  /@foliojs-fork/pdfkit/0.14.0:
    '@foliojs-fork/pdfkit': private
  /@foliojs-fork/restructure/2.0.2:
    '@foliojs-fork/restructure': private
  /@form-validation/plugin-aria/2.4.0:
    '@form-validation/plugin-aria': private
  /@form-validation/plugin-declarative/2.4.0:
    '@form-validation/plugin-declarative': private
  /@form-validation/plugin-default-submit/2.4.0:
    '@form-validation/plugin-default-submit': private
  /@form-validation/plugin-dependency/2.4.0:
    '@form-validation/plugin-dependency': private
  /@form-validation/plugin-sequence/2.4.0:
    '@form-validation/plugin-sequence': private
  /@form-validation/plugin-submit-button/2.4.0:
    '@form-validation/plugin-submit-button': private
  /@form-validation/plugin-trigger/2.4.0:
    '@form-validation/plugin-trigger': private
  /@form-validation/validator-base64/2.4.0:
    '@form-validation/validator-base64': private
  /@form-validation/validator-between/2.4.0:
    '@form-validation/validator-between': private
  /@form-validation/validator-bic/2.4.0:
    '@form-validation/validator-bic': private
  /@form-validation/validator-blank/2.4.0:
    '@form-validation/validator-blank': private
  /@form-validation/validator-callback/2.4.0:
    '@form-validation/validator-callback': private
  /@form-validation/validator-choice/2.4.0:
    '@form-validation/validator-choice': private
  /@form-validation/validator-color/2.4.0:
    '@form-validation/validator-color': private
  /@form-validation/validator-credit-card/2.4.0:
    '@form-validation/validator-credit-card': private
  /@form-validation/validator-cusip/2.4.0:
    '@form-validation/validator-cusip': private
  /@form-validation/validator-date/2.4.0:
    '@form-validation/validator-date': private
  /@form-validation/validator-different/2.4.0:
    '@form-validation/validator-different': private
  /@form-validation/validator-digits/2.4.0:
    '@form-validation/validator-digits': private
  /@form-validation/validator-ean/2.4.0:
    '@form-validation/validator-ean': private
  /@form-validation/validator-ein/2.4.0:
    '@form-validation/validator-ein': private
  /@form-validation/validator-email-address/2.4.0:
    '@form-validation/validator-email-address': private
  /@form-validation/validator-file/2.4.0:
    '@form-validation/validator-file': private
  /@form-validation/validator-greater-than/2.4.0:
    '@form-validation/validator-greater-than': private
  /@form-validation/validator-grid/2.4.0:
    '@form-validation/validator-grid': private
  /@form-validation/validator-hex/2.4.0:
    '@form-validation/validator-hex': private
  /@form-validation/validator-iban/2.4.0:
    '@form-validation/validator-iban': private
  /@form-validation/validator-id/2.4.0:
    '@form-validation/validator-id': private
  /@form-validation/validator-identical/2.4.0:
    '@form-validation/validator-identical': private
  /@form-validation/validator-imei/2.4.0:
    '@form-validation/validator-imei': private
  /@form-validation/validator-imo/2.4.0:
    '@form-validation/validator-imo': private
  /@form-validation/validator-integer/2.4.0:
    '@form-validation/validator-integer': private
  /@form-validation/validator-ip/2.4.0:
    '@form-validation/validator-ip': private
  /@form-validation/validator-isbn/2.4.0:
    '@form-validation/validator-isbn': private
  /@form-validation/validator-isin/2.4.0:
    '@form-validation/validator-isin': private
  /@form-validation/validator-ismn/2.4.0:
    '@form-validation/validator-ismn': private
  /@form-validation/validator-issn/2.4.0:
    '@form-validation/validator-issn': private
  /@form-validation/validator-less-than/2.4.0:
    '@form-validation/validator-less-than': private
  /@form-validation/validator-mac/2.4.0:
    '@form-validation/validator-mac': private
  /@form-validation/validator-meid/2.4.0:
    '@form-validation/validator-meid': private
  /@form-validation/validator-not-empty/2.4.0:
    '@form-validation/validator-not-empty': private
  /@form-validation/validator-numeric/2.4.0:
    '@form-validation/validator-numeric': private
  /@form-validation/validator-phone/2.4.0:
    '@form-validation/validator-phone': private
  /@form-validation/validator-promise/2.4.0:
    '@form-validation/validator-promise': private
  /@form-validation/validator-regexp/2.4.0:
    '@form-validation/validator-regexp': private
  /@form-validation/validator-remote/2.4.0:
    '@form-validation/validator-remote': private
  /@form-validation/validator-rtn/2.4.0:
    '@form-validation/validator-rtn': private
  /@form-validation/validator-sedol/2.4.0:
    '@form-validation/validator-sedol': private
  /@form-validation/validator-siren/2.4.0:
    '@form-validation/validator-siren': private
  /@form-validation/validator-siret/2.4.0:
    '@form-validation/validator-siret': private
  /@form-validation/validator-step/2.4.0:
    '@form-validation/validator-step': private
  /@form-validation/validator-string-case/2.4.0:
    '@form-validation/validator-string-case': private
  /@form-validation/validator-string-length/2.4.0:
    '@form-validation/validator-string-length': private
  /@form-validation/validator-uri/2.4.0:
    '@form-validation/validator-uri': private
  /@form-validation/validator-uuid/2.4.0:
    '@form-validation/validator-uuid': private
  /@form-validation/validator-vat/2.4.0:
    '@form-validation/validator-vat': private
  /@form-validation/validator-vin/2.4.0:
    '@form-validation/validator-vin': private
  /@form-validation/validator-zip-code/2.4.0:
    '@form-validation/validator-zip-code': private
  /@fullcalendar/premium-common/6.1.11(@fullcalendar/core@6.1.11):
    '@fullcalendar/premium-common': private
  /@fullcalendar/scrollgrid/6.1.11(@fullcalendar/core@6.1.11):
    '@fullcalendar/scrollgrid': private
  ...
  /datatables.net-fixedcolumns/4.3.1:
    datatables.net-fixedcolumns: private
  /datatables.net-fixedheader/3.4.1:
    datatables.net-fixedheader: private
  /datatables.net-rowgroup/1.5.0:
    datatables.net-rowgroup: private
  /datatables.net-select/1.7.1:
    datatables.net-select: private
  /debug/4.3.4:
    debug: private
  /deep-equal/1.1.2:
    deep-equal: private
  ...
  /tapable/2.2.1:
    tapable: private
  /terser-webpack-plugin/5.3.10(webpack@5.88.1):
...
pendingBuilds: []
prunedAt: Tue, 27 Feb 2024 09:36:52 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@rollup/rollup-win32-ia32-msvc/4.12.0
  - /fsevents/2.3.3
storeDir: C:\Users\Steve\AppData\Local\pnpm\store\v3
virtualStoreDir: C:\Users\Steve\Documents\Deveint Projects\ob-system\node_modules\.pnpm
