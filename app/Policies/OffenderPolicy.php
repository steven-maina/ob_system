...
class OffenderPolicy
{
     ...
     */
    public function view(User $user, Offender $model): bool
    {
     ...
     */
    public function update(User $user, Offender $model): bool
    {
     ...
     */
    public function delete(User $user, Offender $model): bool
    {
     ...
     */
    public function restore(User $user, Offender $model): bool
    {
        return false;
    }
