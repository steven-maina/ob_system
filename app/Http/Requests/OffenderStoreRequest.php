...
class OffenderStoreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'photo1' => ['sometimes', 'image', 'max:5120'],
            'photo2' => ['sometimes', 'image', 'max:5120'],
            'photo3' => ['sometimes', 'image', 'max:5120'],
            'added_by' => ['nullable'],
        ];
    }
