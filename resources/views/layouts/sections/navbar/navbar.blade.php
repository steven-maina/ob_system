          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                    <a class="dropdown-item" href="{{ Route::has('profile.show') ? route('profile') : route('profile') }}">
                      <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                          <div class="avatar avatar-online">
                            <img src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('img/img.png') ?? asset('img/img_1.png') }}" alt class="h-auto rounded-circle">
                          </div>
                        </div>
                        <div class="flex-grow-1">
...
{{--                              @endauth--}}
                  ...
                  <li>
                    <a class="dropdown-item" href="{{ Route::has('profile.show') ? route('profile.show') : route('profile') }}">
