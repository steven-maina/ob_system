@php
  use Illuminate\Support\Facades\Auth;$containerNav = (isset($configData['contentLayout']) && $configData['contentLayout'] === 'compact') ? 'container-xxl' : 'container-fluid';
                  ...
                  <div class="dropdown-shortcuts-list scrollable-container">
                    ...
                    <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                      <i class="ti ti-users fs-4"></i>
                        ...
                        <a href="{{route('users.index')}}" class="stretched-link">User App</a>
                      ...
                      <li class="list-group-item list-group-item-action dropdown-notifications-item">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar">
                              <img src="{{ asset('assets/img/img_3.png') }}" alt class="h-auto rounded-circle">
                            </div>
                          </div>
                        </div>
                      </li>
                ...
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    @if(Auth::user() && Auth::user()->profile_photo_url)
                      <img src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('assets/img/img_1.png') }}" alt class="h-auto rounded-circle">
                    @else
                      <img src="{{asset('assets/img/img_1.png') }}" alt class="h-auto rounded-circle">
                    @endif                  </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                    <a class="dropdown-item"
                       href="{{ Route::has('profile.show') ? route('profile') : route('profile') }}">
                      <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                          <div class="avatar avatar-online">
                            @if(Auth::user() && Auth::user()->profile_photo_url)
                        ...
                        @endif
                          ...
                          <small class="text-muted">
                            @if(Auth::user() && auth()->user()->roles->isNotEmpty())
                              ...
                              {{--                              @auth--}}
                              {{--                                <p><i class="fa fa-clock px"></i>Last Logged In: {{ auth()->user()->last_login_at }}</p>--}}
                              {{--                              @endauth--}}
                            @endif</small>
                        </div>
                      </div>
                  ...
                  <li>
                    <a class="dropdown-item"
                       href="{{ Route::has('profile.show') ? route('profile.show') : route('profile') }}">
                  ...
                  @else
                    <li>
                      <a class="dropdown-item" href="{{ Route::has('login') ? route('login') : route('/login') }}">
